  ...
  "profile": {
    ...
    "journey": [
      ...
      },
      {
        ...
        "note": "Built home automation systems, RC cars, relay circuits, and IR-controlled projects. Countless experiments, failures, and lessons became the foundation of everything that followed."
      },
      {
        "year": "2022",
        "title": "GRAVAS",
        "note": "Developed my first major engineering project and showcased it at Rojgar Mela. It was the moment I realized I wanted to build real-world technology for a living."
      },
      {
        "year": "2023",
        "title": "From Projects to Products",
        "note": "Focused on embedded systems, IoT, and hardware-software integration while developing practical solutions that could move beyond classroom prototypes."
      },
      {
        "year": "2024",
        "title": "Suraksha Ghar",
        "note": "Built a complete IoT home automation ecosystem featuring custom firmware, hardware integration, and a companion mobile application — my first product designed for real-world use."
      },
      {
        "year": "2025",
        "title": "National Recognition",
        "note": "Won multiple awards across Nepal's engineering competitions including UDAAN 2025 (Winner), OCTATE 2025 (Public Choice Award), Innosphere 1.0 (First Runner-Up), and Hackathon Nova, while earning recognition for technical innovation and leadership."
      },
      {
        "year": "2026",
        "title": "Building What's Next",
        "note": "Leading the development of projects including Swasthya Sathi, SwiftIgnite v2, Suraksha360, and commercial web solutions while serving as Joint Secretary of CAPEC and continuing to build products that solve real-world problems."
      }
    ],
    "fun_facts": [
