...
export const EMBEDDED_DATA = {
  "profile": {
    ...
    "testimonials": [
      ...
      {
        "quote": "Served as a Core Organizer for Hackathon Nova, contributing significantly to event planning, logistical coordination, volunteer management, and on-site operational execution. His structured approach to management, effective coordination, and prompt problem-solving during the event ensured smooth operations and an excellent experience for all participants, volunteers, and stakeholders.",
        "source": "Hackathon Nova organizing team"
      }
    ],
    "featured_in": [
      {
  ...
  "achievements": [
    ...
    },
    {
      ...
      "title": "Suraksha Ghar — Community Partner & Core Organizer",
      "detail": "Certificate of Appreciation as Community Partner (Suraksha Ghar). Also served as Core Organizer for Hackathon Nova — event planning, logistics, volunteer management, and on-site operations.",
      "images": [
